...
#ifdef WEBIF_WIKI
	DEF_OPT_STR("httphelplang"              , OFS(http_help_lang)           , "de,fr,es,it,nl,pl,pt,ru,cs,hu,tr,ar,zh,ja"),
	DEF_OPT_INT8("httphelpapi"              , OFS(http_help_api)            , 0),
	DEF_OPT_STR("httphelpkey"               , OFS(http_help_key)            , NULL),
#endif
