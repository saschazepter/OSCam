...
libraries="WITH_LIB_MINILZO WITH_LIB_AES WITH_LIB_MD5 WITH_LIB_MDC2 WITH_LIB_DES WITH_LIB_SHA1 WITH_LIB_SHA256 WITH_LIB_RC6 WITH_LIB_IDEA WITH_LIB_BIGNUM"
